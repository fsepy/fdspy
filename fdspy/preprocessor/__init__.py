EXAMPLE_FDS_SCRIPT_RIU_MOE1 = """
moe1.fds
Generated by PyroSim - Version 2019.1.0515
23-Aug-2019 19:06:05

&HEAD CHID='moe1'/
&TIME T_END=400.0, RESTRICT_TIME_STEP=.FALSE./
&DUMP RENDER_FILE='moe1.ge1', COLUMN_DUMP_LIMIT=.TRUE., DT_BNDF=1.0, DT_DEVC=1.0, DT_HRR=1.0, DT_ISOF=1.0, DT_PART=1.0, DT_PROF=1.0, DT_SLCF=1.0, DT_SL3D=1.0/

&MESH ID='stair upper02', IJK=7,15,82, XB=4.2,4.9,-22.0,-20.5,11.1,19.3, MPI_PROCESS=0/
&MESH ID='corridor 1', IJK=19,8,27, XB=20.2,22.1,-22.9,-22.1,8.4,11.1, MPI_PROCESS=0/
&MESH ID='corridor', IJK=243,17,27, XB=4.2,28.5,-22.1,-20.4,8.4,11.1, MPI_PROCESS=0/
&MESH ID='flat 2', IJK=69,47,27, XB=1.509903E-14,6.9,-16.8,-12.1,8.4,11.1, MPI_PROCESS=1/
&MESH ID='flat 1', IJK=27,36,27, XB=4.2,6.9,-20.4,-16.8,8.4,11.1, MPI_PROCESS=1/
&MESH ID='stair', IJK=35,59,27, XB=0.7,4.2,-22.7,-16.8,8.4,11.1, MPI_PROCESS=2/
&MESH ID='lobby 1', IJK=26,6,27, XB=4.2,6.8,-22.7,-22.1,8.4,11.1, MPI_PROCESS=2/
&MESH ID='lobby 2', IJK=42,26,27, XB=2.6,6.8,-25.3,-22.7,8.4,11.1, MPI_PROCESS=2/
&MESH ID='lobby 3', IJK=19,59,27, XB=2.4,4.3,-31.2,-25.3,8.4,11.1, MPI_PROCESS=2/
&MESH ID='stair upper', IJK=35,59,57, XB=0.7,4.2,-22.7,-16.8,13.6,19.3, MPI_PROCESS=3/
&MESH ID='stair lower', IJK=35,59,38, XB=0.7,4.2,-22.7,-16.8,4.6,8.4, MPI_PROCESS=4/
&MESH ID='stair upper01', IJK=35,59,25, XB=0.7,4.2,-22.7,-16.8,11.1,13.6, MPI_PROCESS=4/
...
&RAMP ID='ventilation_RAMP', T=-0.25, F=1.0/
&RAMP ID='ventilation_RAMP', T=0.25, F=-1.0/
&RAMP ID='ventilation_RAMP', T=239.75, F=-1.0/
&RAMP ID='ventilation_RAMP', T=240.25, F=1.0/
&RAMP ID='door_RAMP', T=-0.25, F=1.0/
&RAMP ID='door_RAMP', T=0.25, F=-1.0/
&RAMP ID='door_RAMP', T=239.75, F=-1.0/
&RAMP ID='door_RAMP', T=240.25, F=1.0/
&RAMP ID='doorflat_RAMP', T=-0.25, F=1.0/
&RAMP ID='doorflat_RAMP', T=0.25, F=-1.0/
&RAMP ID='doorflat_RAMP', T=239.75, F=-1.0/
&RAMP ID='doorflat_RAMP', T=240.25, F=1.0/
&RAMP ID='doorflat_RAMP', T=259.75, F=1.0/
&RAMP ID='doorflat_RAMP', T=260.25, F=-1.0/
&CTRL ID='ventilation', FUNCTION_TYPE='CUSTOM', RAMP_ID='ventilation_RAMP', LATCH=.FALSE., INPUT_ID='TIME'/
&CTRL ID='invert', FUNCTION_TYPE='ALL', LATCH=.FALSE., INITIAL_STATE=.TRUE., INPUT_ID='ventilation'/
&CTRL ID='invert2', FUNCTION_TYPE='ALL', LATCH=.FALSE., INITIAL_STATE=.TRUE., INPUT_ID='door'/
&CTRL ID='door', FUNCTION_TYPE='CUSTOM', RAMP_ID='door_RAMP', LATCH=.FALSE., INPUT_ID='TIME2'/
&CTRL ID='invert3', FUNCTION_TYPE='ALL', LATCH=.FALSE., INITIAL_STATE=.TRUE., INPUT_ID='doorflat'/
&CTRL ID='doorflat', FUNCTION_TYPE='CUSTOM', RAMP_ID='doorflat_RAMP', LATCH=.FALSE., INPUT_ID='TIME2'/
&DEVC ID='FLOW + fire_origin_window', QUANTITY='VOLUME FLOW +', XB=0.9,5.9,-12.7,-12.7,8.5,9.0/
&DEVC ID='FLOW - fire_origin_window', QUANTITY='VOLUME FLOW -', XB=0.9,5.9,-12.7,-12.7,8.5,9.0/
&DEVC ID='FLOW + fire_origin_door', QUANTITY='VOLUME FLOW +', XB=6.0,6.8,-20.4,-20.4,8.5,10.5/
&DEVC ID='FLOW - fire_origin_door', QUANTITY='VOLUME FLOW -', XB=6.0,6.8,-20.4,-20.4,8.5,10.5/
&DEVC ID='FLOW + aov_stair_top', QUANTITY='VOLUME FLOW +', XB=1.8,3.0,-20.3,-19.1,18.4,18.4/
&DEVC ID='FLOW - aov_stair_top', QUANTITY='VOLUME FLOW -', XB=1.8,3.0,-20.3,-19.1,18.4,18.4/
&DEVC ID='FLOW + stair_lobby_door', QUANTITY='VOLUME FLOW +', XB=5.1,6.7,-22.1,-22.1,8.5,10.5/
&DEVC ID='FLOW - stair_lobby_door', QUANTITY='VOLUME FLOW -', XB=5.1,6.7,-22.1,-22.1,8.5,10.5/
&DEVC ID='FLOW + vent_1', QUANTITY='VOLUME FLOW +', XB=4.9,4.9,-21.8,-20.6,10.0,10.4/
&DEVC ID='FLOW - vent_1', QUANTITY='VOLUME FLOW -', XB=4.9,4.9,-21.8,-20.6,10.0,10.4/
&DEVC ID='FLOW - vent_2', QUANTITY='VOLUME FLOW -', XB=28.4,28.4,-21.8,-20.8,9.9,10.9/
&DEVC ID='FLOW + vent_2', QUANTITY='VOLUME FLOW +', XB=28.4,28.4,-21.8,-20.8,9.9,10.9/
&DEVC ID='FLOW + stair_door', QUANTITY='VOLUME FLOW +', XB=2.7,4.3,-22.7,-22.7,8.5,10.5/
&DEVC ID='FLOW - stair_door', QUANTITY='VOLUME FLOW -', XB=2.7,4.3,-22.7,-22.7,8.5,10.5/
&DEVC ID='TIME', QUANTITY='TIME', XYZ=4.2,-22.0,11.1/
&DEVC ID='TIME2', QUANTITY='TIME', XYZ=4.2,-22.0,11.1/
...
&SURF ID='LINING CONCRETE',
      ...
      THICKNESS(1)=0.2/
&SURF ID='LINING PLASTER_BOARD',
      COLOR='GRAY 80',
      BACKING='VOID',
      MATL_ID(1,1)='GYPSUM',
      MATL_MASS_FRACTION(1,1)=1.0,
      THICKNESS(1)=0.02/
&SURF ID='VENT EXHAUST 5',
      RGB=51,153,0,
      VOLUME_FLOW=5.0,
      TAU_V=-30.0/
...
&OBST ID='fire 1.25MW 1.4m', XB=2.7,4.1,-15.4,-14.0,8.5,8.6, SURF_IDS='BURNER 1MW 1.2m','INERT','INERT'/ 
&OBST ID='stair floor_i', XB=0.8,4.1,-22.6,-20.8,15.1,15.4, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='stair floor_i', XB=0.8,4.1,-22.6,-20.8,11.9,12.2, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='stair floor_i', XB=0.8,4.1,-22.6,-20.8,8.3,8.5, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='stair floor_i', XB=0.6,4.1,-18.3,-16.9,16.7,17.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='stair floor_i', XB=0.6,4.1,-18.3,-16.9,13.5,13.8, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='stair floor_i', XB=0.6,4.1,-18.3,-16.9,10.1,10.4, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='stair floor_i', XB=0.6,4.1,-18.3,-16.9,6.4,6.7, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='stair floor', XB=0.8,4.1,-22.6,-16.9,3.7,4.9, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='stair_lobby floor', XB=2.5,4.2,-22.7,-22.6,8.4,8.5, SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair_lobby floor', XB=4.1,4.2,-22.6,-22.1,8.4,8.5, SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair_lobby floor', XB=4.2,6.8,-22.7,-22.1,8.4,8.5, SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair_lobby floor', XB=2.6,6.8,-25.3,-22.7,8.4,8.5, SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair_lobby floor', XB=2.4,4.3,-31.2,-25.3,8.4,8.5, SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair_lobby floor', XB=2.5,4.2,-22.7,-22.6,7.3,8.4, SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair_lobby floor', XB=4.1,4.2,-22.6,-22.1,7.3,8.4, SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair_lobby soffit', XB=4.2,6.8,-22.1,-22.0,11.0,11.1, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair_lobby soffit', XB=2.6,4.2,-22.7,-22.6,11.0,11.1, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair_lobby soffit', XB=4.1,4.2,-22.6,-22.0,11.0,11.1, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair_lobby soffit', XB=4.2,6.8,-22.7,-22.1,11.0,11.1, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair_lobby soffit', XB=2.6,6.8,-25.3,-22.7,11.0,11.1, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair_lobby soffit', XB=2.4,4.3,-31.2,-25.3,11.0,11.1, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair_lobby soffit', XB=2.6,4.2,-22.7,-22.6,11.1,12.2, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair_lobby soffit', XB=4.1,4.2,-22.6,-22.0,11.1,12.2, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='corridor floor', XB=20.2,22.1,-22.9,-22.1,8.4,8.5, SURF_ID='LINING CONCRETE'/ 
&OBST ID='corridor floor', XB=4.2,28.5,-22.1,-20.4,8.4,8.5, SURF_ID='LINING CONCRETE'/ 
&OBST ID='corridor floor', XB=4.2,6.9,-20.4,-20.3,8.4,8.5, SURF_ID='LINING CONCRETE'/ 
&OBST ID='corridor floor', XB=4.1,4.2,-22.2,-20.3,8.4,8.5, SURF_ID='LINING CONCRETE'/ 
&OBST ID='corridor floor', XB=4.2,6.8,-22.2,-22.1,8.4,8.5, SURF_ID='LINING CONCRETE'/ 
&OBST ID='corridor floor', XB=4.1,4.2,-22.2,-20.3,7.3,8.4, SURF_ID='LINING CONCRETE'/ 
&OBST ID='flat floor', XB=1.509903E-14,6.9,-16.8,-12.6,8.4,8.5, SURF_ID='LINING CONCRETE'/ 
&OBST ID='flat floor', XB=4.2,6.9,-20.3,-16.8,8.4,8.5, SURF_ID='LINING CONCRETE'/ 
&OBST ID='flat floor', XB=0.7,4.2,-16.9,-16.8,8.4,8.5, SURF_ID='LINING CONCRETE'/ 
&OBST ID='flat floor', XB=4.1,4.2,-20.3,-16.9,8.4,8.5, SURF_ID='LINING CONCRETE'/ 
&OBST ID='flat floor', XB=0.7,4.2,-16.9,-16.8,7.3,8.4, SURF_ID='LINING CONCRETE'/ 
&OBST ID='flat floor', XB=4.1,4.2,-20.3,-16.9,7.3,8.4, SURF_ID='LINING CONCRETE'/ 
&OBST ID='flat soffit', XB=1.509903E-14,6.9,-16.8,-12.6,11.0,11.1, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='flat soffit', XB=4.2,6.9,-20.3,-16.8,11.0,11.1, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='flat soffit', XB=0.7,4.2,-16.9,-16.8,11.0,11.1, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='flat soffit', XB=4.1,4.2,-20.3,-16.9,11.0,11.1, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='flat soffit', XB=0.7,4.2,-16.9,-16.8,11.1,12.2, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='flat soffit', XB=4.1,4.2,-20.3,-16.9,11.1,12.2, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='flat wall', XB=1.509903E-14,0.6,-16.8,-16.7,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='flat wall', XB=1.509903E-14,6.9,-12.8,-12.6,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='flat wall', XB=6.8,6.9,-16.8,-12.8,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='flat wall', XB=1.509903E-14,1.509903E-14,-16.7,-12.8,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='flat wall', XB=6.8,6.9,-20.3,-16.8,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='stair_lobby wall', XB=6.6,6.8,-22.7,-22.2,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='stair_lobby wall', XB=2.6,2.7,-25.3,-22.8,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='stair_lobby wall', XB
COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair wall', XB=0.7,4.2,-16.9,-16.8,4.6,8.4, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair wall', XB=4.1,4.2,-22.6,-16.9,4.6,8.4, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair wall', XB=0.7,0.8,-22.6,-16.9,11.1,13.6, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair wall', XB=0.7,4.2,-22.7,-22.6,11.1,13.6, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair wall', XB=0.7,4.2,-16.9,-16.8,11.1,13.6, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair wall', XB=4.1,4.2,-22.6,-16.9,11.1,13.6, COLOR='INVISIBLE', SURF_ID='LINING CONCRETE'/ 
&OBST ID='stair soffit', XB=1.8,3.0,-20.3,-19.1,18.3,18.5, SURF_ID='LINING PLASTER_BOARD', CTRL_ID='invert'/ 
&OBST ID='stair soffit', XB=4.2,4.3,-22.0,-20.5,18.3,18.5, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='stair soffit', XB=0.7,1.8,-20.3,-19.1,18.3,18.5, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='stair soffit', XB=0.7,4.2,-22.7,-20.3,18.3,18.5, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='stair soffit', XB=0.7,4.2,-19.1,-16.8,18.3,18.5, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='stair soffit', XB=3.0,4.2,-20.3,-19.1,18.3,18.5, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=5.5,6.3,-22.1,-22.0,8.5,10.5, SURF_ID='LINING PLASTER_BOARD', CTRL_ID='invert2'/ 
&OBST ID='corridor wall', XB=5.5,6.3,-22.2,-22.1,8.5,10.5, SURF_ID='LINING PLASTER_BOARD', CTRL_ID='invert2'/ 
&OBST ID='corridor wall', XB=6.0,6.8,-20.5,-20.4,8.5,10.5, SURF_ID='LINING PLASTER_BOARD', CTRL_ID='invert3'/ 
&OBST ID='corridor wall', XB=6.0,6.8,-20.4,-20.3,8.5,10.5, SURF_ID='LINING PLASTER_BOARD', CTRL_ID='invert3'/ 
&OBST ID='corridor wall', XB=20.2,20.3,-22.8,-22.1,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=20.2,22.1,-22.9,-22.8,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=22.0,22.1,-22.8,-22.1,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=4.2,4.3,-22.0,-20.5,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=4.2,5.5,-22.1,-22.0,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=4.2,6.0,-20.5,-20.4,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=5.5,6.3,-22.1,-22.0,10.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=6.0,6.8,-20.5,-20.4,10.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=6.3,20.3,-22.1,-22.0,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=6.8,28.5,-20.5,-20.4,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=22.0,28.5,-22.1,-22.0,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=28.4,28.5,-22.0,-20.5,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=4.2,6.0,-20.4,-20.3,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=6.0,6.8,-20.4,-20.3,10.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=6.8,6.9,-20.4,-20.3,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=4.1,4.2,-22.2,-20.3,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=4.2,5.5,-22.2,-22.1,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=5.5,6.3,-22.2,-22.1,10.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 
&OBST ID='corridor wall', XB=6.3,6.8,-22.2,-22.1,8.5,11.0, SURF_ID='LINING PLASTER_BOARD'/ 

&HOLE ID='window - fire origin', XB=0.9,5.9,-13.2,-12.2,8.5,9.0/ 
&HOLE ID='door - stair_bottom', XB=3.0,3.4,-23.1,-22.3,4.9,6.9/ 

&VENT ID='Mesh Vent: stair upper02 [ZMAX]', SURF_ID='OPEN', XB=4.2,4.9,-22.0,-20.5,19.3,19.3/ 
&VENT ID='Mesh Vent: corridor 1 [XMAX]', SURF_ID='OPEN', XB=22.1,22.1,-22.9,-22.1,8.4,11.1/ 
&VENT ID='Mesh Vent: corridor 1 [XMIN]', SURF_ID='OPEN', XB=20.2,20.2,-22.9,-22.1,8.4,11.1/ 
&VENT ID='Mesh Vent: corridor 1 [YMIN]', SURF_ID='OPEN', XB=20.2,22.1,-22.9,-22.9,8.4,11.1/ 
&VENT ID='Mesh Vent: corridor 1 [ZMAX]', SURF_ID='OPEN', XB=20.2,22.1,-22.9,-22.1,11.1,11.1/ 
&VENT ID='Mesh Vent: corridor 1 [ZMIN]', SURF_ID='OPEN', XB=20.2,22.1,-22.9,-22.1,8.4,8.4/ 
&VENT ID='Mesh Vent: corridor [XMAX]', SURF_ID='OPEN', XB=28.5,28.5,-22.1,-20.4,8.4,11.1/ 
&VENT ID='Mesh Vent: corridor [YMAX]', SURF_ID='OPEN', XB=6.9,28.5,-20.4,-20.4,8.4,11.1/ 
&VENT ID='Mesh Vent: corridor [YMIN]', SURF_ID='OPEN', XB=22.1,28.5,-22.1,-22.1,8.4,11.1/ 
&VENT ID='Mesh Vent: corridor [YMIN]', SURF_ID='OPEN', XB=6.8,20.2,-22.1,-22.1,8.4,11.1/ 
&VENT ID='Mesh Vent: corridor [ZMAX]', SURF_ID='OPEN', XB=4.9,28.5,-22.0,-20.5,11.1,11.1/ 
&VENT ID='Mesh Vent: corridor [ZMAX]', SURF_ID='OPEN', XB=4.2,28.5,-22.1,-22.0,11.1,11.1/ 
&VENT ID='Mesh Vent: corridor [ZMAX]', SURF_ID='OPEN', XB=4.2,28.5,-20.5,-20.4,11.1,11.1/ 
&VENT ID='Mesh Vent: corridor [ZMIN]', SURF_ID='OPEN', XB=4.2,28.5,-22.1,-20.4,8.4,8.4/ 
&VENT ID='Mesh Vent: flat 2 [XMAX]', SURF_ID='OPEN', XB=6.9,6.9,-16.8,-12.1,8.4,11.1/ 
&VENT ID='Mesh Vent: flat 2 [XMIN]', SURF_ID='OPEN', XB=1.509903E-14,1.509903E-14,-16.8,-12.1,8.4,11.1/ 
&VENT ID='Mesh Vent: flat 2 [YMAX]', SURF_ID='OPEN', XB=1.509903E-14,6.9,-12.1,-12.1,8.4,11.1/ 
&VENT ID='Mesh Vent: flat 2 [YMIN]', SURF_ID='OPEN', XB=1.509903E-14,0.7,-16.8,-16.8,8.4,11.1/ 
&VENT ID='Mesh Vent: flat 2 [ZMAX]', SURF_ID='OPEN', XB=1.509903E-14,6.9,-16.8,-12.1,11.1,11.1/ 
&VENT ID='Mesh Vent: flat 2 [ZMIN]', SURF_ID='OPEN', XB=1.509903E-14,6.9,-16.8,-12.1,8.4,8.4/ 
&VENT ID='Mesh Vent: flat 1 [XMAX]', SURF_ID='OPEN', XB=6.9,6.9,-20.4,-16.8,8.4,11.1/ 
&VENT ID='Mesh Vent: flat 1 [ZMAX]', SURF_ID='OPEN', XB=4.2,6.9,-20.4,-16.8,11.1,11.1/ 
&VENT ID='Mesh Vent: flat 1 [ZMIN]', SURF_ID='OPEN', XB=4.2,6.9,-20.4,-16.8,8.4,8.4/ 
&VENT ID='Mesh Vent: stair [XMIN]', SURF_ID='OPEN', XB=0.7,0.7,-22.7,-16.8,8.4,11.1/ 
&VENT ID='Mesh Vent: stair [YMIN]', SURF_ID='OPEN', XB=0.7,2.6,-22.7,-22.7,8.4,11.1/ 
&VENT ID='Mesh Vent: lobby 1 [XMAX]', SURF_ID='OPEN', XB=6.8,6.8,-22.7,-22.1,8.4,11.1/ 
&VENT ID='Mesh Vent: lobby 1 [ZMAX]', SURF_ID='OPEN', XB=4.2,6.8,-22.7,-22.1,11.1,11.1/ 
&VENT ID='Mesh Vent: lobby 1 [ZMIN]', SURF_ID='OPEN', XB=4.2,6.8,-22.7,-22.1,8.4,8.4/ 
&VENT ID='Mesh Vent: lobby 2 [XMAX]', SURF_ID='OPEN', XB=6.8,6.8,-25.3,-22.7,8.4,11.1/ 
&VENT ID='Mesh Vent: lobby 2 [XMIN]', SURF_ID='OPEN', XB=2.6,2.6,-25.3,-22.7,8.4,11.1/ 
&VENT ID='Mesh Vent: lobby 2 [YMIN]', SURF_ID='OPEN', XB=4.3,6.8,-25.3,-25.3,8.4,11.1/ 
&VENT ID='Mesh Vent: lobby 2 [ZMAX]', SURF_ID='OPEN', XB=2.6,6.8,-25.3,-22.7,11.1,11.1/ 
&VENT ID='Mesh Vent: lobby 2 [ZMIN]', SURF_ID='OPEN', XB=2.6,6.8,-25.3,-22.7,8.4,8.4/ 
&VENT ID='Mesh Vent: lobby 3 [XMAX]', SURF_ID='OPEN', XB=4.3,4.3,-31.2,-25.3,8.4,11.1/ 
&VENT ID='Mesh Vent: lobby 3 [XMIN]', SURF_ID='OPEN', XB=2.4,2.4,-31.2,-25.3,8.4,11.1/ 
&VENT ID='Mesh Vent: lobby 3 [YMAX]', SURF_ID='OPEN', XB=2.4,2.6,-25.3,-25.3,8.4,11.1/ 
&VENT ID='Mesh Vent: lobby 3 [YMIN]', SURF_ID='OPEN', XB=2.4,4.3,-31.2,-31.2,8.4,11.1/ 
&VENT ID='Mesh Vent: lobby 3 [ZMAX]', SURF_ID='OPEN', XB=2.4,4.3,-31.2,-25.3,11.1,11.1/ 
&VENT ID='Mesh Vent: lobby 3 [ZMIN]', SURF_ID='OPEN', XB=2.4,4.3,-31.2,-25.3,8.4,8.4/ 
&VENT ID='Mesh Vent: stair upper [XMAX]', SURF_ID='OPEN', XB=4.2,4.2,-22.7,-22.0,13.6,19.3/ 
&VENT ID='Mesh Vent: stair upper [XMAX]', SURF_ID='OPEN', XB=4.2,4.2,-20.5,-16.8,13.6,19.3/ 
&VENT ID='Mesh Vent: stair upper [XMIN]', SURF_ID='OPEN', XB=0.7,0.7,-22.7,-16.8,13.6,19.3/ 
&VENT ID='Mesh Vent: stair upper [YMAX]', SURF_ID='OPEN', XB=0.7,4.2,-16.8,-16.8,13.6,19.3/ 
&VENT ID='Mesh Vent: stair upper [YMIN]', SURF_ID='OPEN', XB=0.7,4.2,-22.7,-22.7,13.6,19.3/ 
&VENT ID='Mesh Vent: stair upper [ZMAX]', SURF_ID='OPEN', XB=0.7,4.2,-22.7,-16.8,19.3,19.3/ 
&VENT ID='Mesh Vent: stair lower [XMAX]', SURF_ID='OPEN', XB=4.2,4.2,-22.7,-16.8,4.6,8.4/ 
&VENT ID='Mesh Vent: stair lower [XMIN]', SURF_ID='OPEN', XB=0.7,0.7,-22.7,-16.8,4.6,8.4/ 
&VENT ID='Mesh Vent: stair lower [YMAX]', SURF_ID='OPEN', XB=0.7,4.2,-16.8,-16.8,4.6,8.4/ 
&VENT ID='Mesh Vent: stair lower [YMIN]', SURF_ID='OPEN', XB=0.7,4.2,-22.7,-22.7,4.6,8.4/ 
&VENT ID='Mesh Vent: stair lower [ZMIN]', SURF_ID='OPEN', XB=0.7,4.2,-22.7,-16.8,4.6,4.6/ 
&VENT ID='Mesh Vent: stair upper01 [XMAX]', SURF_ID='OPEN', XB=4.2,4.2,-22.7,-22.0,11.1,13.6/ 
&VENT ID='Mesh Vent: stair upper01 [XMAX]', SURF_ID='OPEN', XB=4.2,4.2,-20.5,-16.8,11.1,13.6/ 
&VENT ID='Mesh Vent: stair upper01 [XMIN]', SURF_ID='OPEN', XB=0.7,0.7,-22.7,-16.8,11.1,13.6/ 
&VENT ID='Mesh Vent: stair upper01 [YMAX]', SURF_ID='OPEN', XB=0.7,4.2,-16.8,-16.8,11.1,13.6/ 
&VENT ID='Mesh Vent: stair upper01 [YMIN]', SURF_ID='OPEN', XB=0.7,4.2,-22.7,-22.7,11.1,13.6/ 
&VENT ID='exhaust vent', SURF_ID='VENT EXHAUST 5', XB=28.4,28.4,-21.8,-20.8,9.9,10.9, CTRL_ID='ventilation'/ 

&SLCF QUANTITY='TEMPERATURE', VECTOR=.TRUE., PBX=3.4/
&SLCF QUANTITY='TEMPERATURE', VECTOR=.TRUE., PBX=6.0/
&SLCF QUANTITY='TEMPERATURE', VECTOR=.TRUE., PBY=-21.2/
&SLCF QUANTITY='TEMPERATURE', VECTOR=.TRUE., PBZ=9.9/
&SLCF QUANTITY='TEMPERATURE', VECTOR=.TRUE., PBZ=10.3/
&SLCF QUANTITY='PRESSURE', VECTOR=.TRUE., PBX=3.4/
&SLCF QUANTITY='PRESSURE', VECTOR=.TRUE., PBX=6.0/
&SLCF QUANTITY='PRESSURE', VECTOR=.TRUE., PBY=-21.2/
&SLCF QUANTITY='PRESSURE', VECTOR=.TRUE., PBZ=9.9/
&SLCF QUANTITY='PRESSURE', VECTOR=.TRUE., PBZ=10.3/
&SLCF QUANTITY='VISIBILITY', VECTOR=.TRUE., PBX=3.4/
&SLCF QUANTITY='VISIBILITY', VECTOR=.TRUE., PBX=6.0/
&SLCF QUANTITY='VISIBILITY', VECTOR=.TRUE., PBY=-21.2/
&SLCF QUANTITY='VISIBILITY', VECTOR=.TRUE., PBZ=9.9/
&SLCF QUANTITY='VISIBILITY', VECTOR=.TRUE., PBZ=10.3/
&SLCF QUANTITY='VELOCITY', VECTOR=.TRUE., PBX=3.4/
&SLCF QUANTITY='VELOCITY', VECTOR=.TRUE., PBX=6.0/
&SLCF QUANTITY='VELOCITY', VECTOR=.TRUE., PBY=-21.2/
&SLCF QUANTITY='VELOCITY', VECTOR=.TRUE., PBZ=9.9/
&SLCF QUANTITY='VELOCITY', VECTOR=.TRUE., PBZ=10.3/
...
EXAMPLE_FDS_SCRIPT_ARUP_TUNNEL_FIRE = """&HEAD CHID='Arup_Tunnel', TITLE='Arup tunnel fire experiment' /

&TIME T_END=500. /

&MISC SIMULATION_MODE='SVLES' /

&MESH IJK=120,45,35, XB=-10.,14.,-0.20,8.80,0.0,7.0, MULT_ID='mesh' /
&MULT ID='mesh', DX=24., I_UPPER=4 /
...
&RAMP ID='Burner_RAMP_Q', T=10.0, F=0.70/
&RAMP ID='Burner_RAMP_Q', T=20.0, F=0.82/
&RAMP ID='Burner_RAMP_Q', T=50.0, F=0.83/
&RAMP ID='Burner_RAMP_Q', T=70.0, F=0.85/
&RAMP ID='Burner_RAMP_Q', T=90.0, F=0.83/
&RAMP ID='Burner_RAMP_Q', T=100.0, F=0.86/
&RAMP ID='Burner_RAMP_Q', T=110.0, F=0.89/
&RAMP ID='Burner_RAMP_Q', T=140.0, F=0.87/
&RAMP ID='Burner_RAMP_Q', T=150.0, F=0.88/
&RAMP ID='Burner_RAMP_Q', T=160.0, F=0.88/
&RAMP ID='Burner_RAMP_Q', T=170.0, F=0.93/
&RAMP ID='Burner_RAMP_Q', T=190.0, F=0.95/
&RAMP ID='Burner_RAMP_Q', T=200.0, F=0.97/
&RAMP ID='Burner_RAMP_Q', T=220.0, F=0.94/
&RAMP ID='Burner_RAMP_Q', T=240.0, F=0.97/
&RAMP ID='Burner_RAMP_Q', T=250.0, F=0.95/
&RAMP ID='Burner_RAMP_Q', T=260.0, F=0.91/
&RAMP ID='Burner_RAMP_Q', T=270.0, F=0.88/
&RAMP ID='Burner_RAMP_Q', T=280.0, F=0.86/
&RAMP ID='Burner_RAMP_Q', T=290.0, F=0.80/
&RAMP ID='Burner_RAMP_Q', T=300.0, F=0.58/
&RAMP ID='Burner_RAMP_Q', T=310.0, F=0.10/
&RAMP ID='Burner_RAMP_Q', T=311.0, F=0.00/
&RAMP ID='Burner_RAMP_Q', T=500.0, F=0.00/

&OBST XB=49.00,51.00,3.80,4.80,0.00,0.40, SURF_IDS='Burner','Steel pool','Steel pool'/ 

Output

&DUMP DT_HRR=10., DT_DEVC=10., SIG_FIGS=4, SIG_FIGS_EXP=2 /

&PROP ID='Big TC', BEAD_DIAMETER=0.003 /
&DEVC ID='Tf01', QUANTITY='THERMOCOUPLE', XYZ=50.00,4.30,2.00, PROP_ID='Big TC' /
&DEVC ID='Tf02', QUANTITY='THERMOCOUPLE', XYZ=50.00,4.30,3.00, PROP_ID='Big TC' /
&DEVC ID='Tf03', QUANTITY='THERMOCOUPLE', XYZ=50.00,4.30,4.00, PROP_ID='Big TC' /
&DEVC ID='Tf04', QUANTITY='THERMOCOUPLE', XYZ=50.00,4.30,5.00, PROP_ID='Big TC' /
&DEVC ID='Tl01', QUANTITY='THERMOCOUPLE', XYZ=42.00,4.30,6.50, PROP_ID='Big TC' /
&DEVC ID='Tl02', QUANTITY='THERMOCOUPLE', XYZ=44.00,4.30,6.50, PROP_ID='Big TC' /
&DEVC ID='Tl03', QUANTITY='THERMOCOUPLE', XYZ=46.00,4.30,6.50, PROP_ID='Big TC' /
&DEVC ID='Tl04', QUANTITY='THERMOCOUPLE', XYZ=48.00,4.30,6.50, PROP_ID='Big TC' /
&DEVC ID='Tl05', QUANTITY='THERMOCOUPLE', XYZ=50.00,4.30,6.50, PROP_ID='Big TC' /
&DEVC ID='Tl06', QUANTITY='THERMOCOUPLE', XYZ=52.00,4.30,6.50, PROP_ID='Big TC' /
&DEVC ID='Tl07', QUANTITY='THERMOCOUPLE', XYZ=54.00,4.30,6.50, PROP_ID='Big TC' /
&DEVC ID='Tl08', QUANTITY='THERMOCOUPLE', XYZ=56.00,4.30,6.50, PROP_ID='Big TC' /
&DEVC ID='Tl09', QUANTITY='THERMOCOUPLE', XYZ=58.00,4.30,6.50, PROP_ID='Big TC' /
&DEVC ID='Tp01', QUANTITY='WALL TEMPERATURE', XYZ=45.00,4.30,2.50, IOR=1/
&DEVC ID='Tp10', QUANTITY='WALL TEMPERATURE', XYZ=45.00,4.30,4.00, IOR=-3/
&DEVC ID='Tp02', QUANTITY='WALL TEMPERATURE', XYZ=45.00,4.30,3.50, IOR=1/
&DEVC ID='Tp09', QUANTITY='WALL TEMPERATURE', XYZ=55.00,4.30,4.00, IOR=-3/
&DEVC ID='Tp05', QUANTITY='WALL TEMPERATURE', XYZ=50.00,8.30,2.50, IOR=-2/
&DEVC ID='Tp04', QUANTITY='WALL TEMPERATURE', XYZ=50.00,0.30,3.50, IOR=2/
&DEVC ID='Tp06', QUANTITY='WALL TEMPERATURE', XYZ=50.00,8.30,3.50, IOR=-2/
&DEVC ID='Tp08', QUANTITY='WALL TEMPERATURE', XYZ=55.00,4.30,3.50, IOR=-1/
&DEVC ID='Tp07', QUANTITY='WALL TEMPERATURE', XYZ=55.00,4.30,2.50, IOR=-1/
&DEVC ID='Tp03', QUANTITY='WALL TEMPERATURE', XYZ=50.00,0.30,2.50, IOR=2/
...
&OBST XB=0.00,100.00,0.80,1.00,5.00,5.40, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,7.20,7.40,5.40,5.80, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,7.80,8.00,4.60,5.20, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,3.00,3.20,6.60,6.80, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,1.80,2.00,6.00,6.20, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,8.20,8.40,3.80,4.60, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,2.00,2.20,6.00,6.40, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,7.00,7.20,5.60,6.00, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,1.60,1.80,5.80,6.20, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,4.20,5.40,6.60,6.80, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,5.60,6.00,6.40,6.80, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,1.40,1.60,5.60,6.00, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,2.20,2.40,6.20,6.40, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,7.60,7.80,5.00,5.40, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,0.60,0.80,4.60,5.20, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,8.00,8.20,4.40,4.80, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,0.00,0.20,0.00,3.80, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,1.00,1.20,5.20,5.60, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,3.20,4.20,6.60,6.80, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,6.40,6.60,6.00,6.40, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,6.00,6.20,6.20,6.60, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,6.20,6.40,6.20,6.40, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,8.40,8.60,0.00,4.00, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,1.20,1.40,5.40,5.80, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,5.40,5.60,6.60,6.80, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,0.40,0.60,4.20,4.80, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,8.00,8.20,4.20,4.60, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,6.80,7.00,5.80,6.20, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,0.20,0.40,3.60,4.40, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,2.40,2.60,6.20,6.60, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,2.60,3.00,6.40,6.80, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,6.60,6.80,6.00,6.20, SURF_ID='CONCRETE'/ 
&OBST XB=0.00,100.00,7.40,7.60,5.20,5.60, SURF_ID='CONCRETE'/ 

&VENT SURF_ID='OPEN', PBX=-10. /
&VENT SURF_ID='OPEN', PBX=110. /
...
&SURF ID='Plate Front'
      ...
      BACKING='EXPOSED'
      THICKNESS=0.0007,0.01
      COLOR='BLACK' /

&SURF ID='Plate Back'
      MATL_ID='INSULATION','STEEL'
      BACKING='EXPOSED'
      THICKNESS=0.01,0.0007
      COLOR='PINK' /
...
&MATL ID='INSULATION',
      ...
      DENSITY=208. /
&RAMP ID='INSULATION_CONDUCTIVITY_RAMP', T=20.00, F=0.0500/
&RAMP ID='INSULATION_CONDUCTIVITY_RAMP', T=377.00, F=0.1000/
&RAMP ID='INSULATION_CONDUCTIVITY_RAMP', T=677.00, F=0.2000/
&RAMP ID='INSULATION_SPECIFIC_HEAT_RAMP', T=20.00, F=0.80/
&RAMP ID='INSULATION_SPECIFIC_HEAT_RAMP', T=677.00, F=2.00/
...
&OBST XB=49.90,50.10,0.30,0.30,2.50,2.60, SURF_ID6='INERT','INERT','Plate Back','Plate Front','INERT','INERT'/ 
&OBST XB=49.90,50.10,8.40,8.40,2.40,2.60, SURF_ID6='INERT','INERT','Plate Front','Plate Back','INERT','INERT'/ 
&OBST XB=55.00,55.00,4.20,4.40,2.40,2.60, SURF_ID6='Plate Front','Plate Back','INERT','INERT','INERT','INERT'/ 
&OBST XB=45.00,45.00,4.20,4.40,2.40,2.60, SURF_ID6='Plate Back','Plate Front','INERT','INERT','INERT','INERT'/ 
&OBST XB=49.90,50.10,0.30,0.30,3.40,3.60, SURF_ID6='INERT','INERT','Plate Back','Plate Front','INERT','INERT'/ 
&OBST XB=49.90,50.10,8.40,8.40,3.40,3.60, SURF_ID6='INERT','INERT','Plate Front','Plate Back','INERT','INERT'/ 
&OBST XB=55.00,55.00,4.20,4.40,3.40,3.60, SURF_ID6='Plate Front','Plate Back','INERT','INERT','INERT','INERT'/
&OBST XB=45.00,45.00,4.20,4.40,3.40,3.60, SURF_ID6='Plate Back','Plate Front','INERT','INERT','INERT','INERT'/ 
&OBST XB=44.90,45.10,4.20,4.40,4.00,4.00, SURF_ID6='INERT','INERT','INERT','INERT','Plate Back','Plate Front'/ 
&OBST XB=54.90,55.10,4.20,4.40,4.00,4.00, SURF_ID6='INERT','INERT','INERT','INERT','Plate Back','Plate Front'/ 

Smokeview Output

&SLCF PBY=4.3, QUANTITY='TEMPERATURE', VECTOR=.TRUE. /

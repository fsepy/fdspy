...
EXAMPLE_FDS_SCRIPT_MALTHOUSE_FF1 = """ff1.fds
Generated by PyroSim - Version 2019.1.0515
07-Nov-2019 10:08:25

&HEAD CHID='ff1'/
&TIME T_END=720.0/
&DUMP RENDER_FILE='ff1.ge1', COLUMN_DUMP_LIMIT=.TRUE., DT_BNDF=1.0, DT_DEVC=1.0, DT_HRR=1.0, DT_ISOF=1.0, DT_PART=1.0, DT_PROF=1.0, DT_SLCF=1.0, DT_SL3D=1.0/

&MESH ID='stair_shaft middle', IJK=104,82,32, XB=6.8,17.2,5.8,14.0,2.9,6.1, MPI_PROCESS=0/
&MESH ID='corridor_1', IJK=24,258,32, XB=6.8,9.2,14.0,39.8,2.9,6.1, MPI_PROCESS=1/
&MESH ID='corridor_2', IJK=224,26,32, XB=17.2,39.6,5.8,8.4,2.9,6.1, MPI_PROCESS=2/
&MESH ID='stair_shaft upper', IJK=84,62,40, XB=8.8,17.2,7.8,14.0,6.1,10.1, MPI_PROCESS=3/
&MESH ID='stair_shaft bottom', IJK=42,31,18, XB=8.8,17.2,7.8,14.0,-0.7,2.9, MPI_PROCESS=3/
&MESH ID='MESH04', IJK=77,70,32, XB=-0.9,6.8,7.7,14.7,2.9,6.1, MPI_PROCESS=4/
...
&RAMP ID='steady_state_RAMP', T=-0.25, F=1.0/
&RAMP ID='steady_state_RAMP', T=0.25, F=-1.0/
&RAMP ID='steady_state_RAMP', T=4.75, F=-1.0/
&RAMP ID='steady_state_RAMP', T=5.25, F=1.0/
&CTRL ID='invert', FUNCTION_TYPE='ALL', LATCH=.FALSE., INITIAL_STATE=.TRUE., INPUT_ID='steady_state'/
&CTRL ID='steady_state', FUNCTION_TYPE='CUSTOM', RAMP_ID='steady_state_RAMP', LATCH=.FALSE., INPUT_ID='TIME'/
&DEVC ID='FLOW + fire_origin_door', QUANTITY='VOLUME FLOW +', XB=7.0,7.0,10.5,11.5,3.1,5.1/
&DEVC ID='FLOW - fire_origin_door', QUANTITY='VOLUME FLOW -', XB=7.0,7.0,10.5,11.5,3.1,5.1/
&DEVC ID='FLOW + stair_door_2', QUANTITY='VOLUME FLOW +', XB=15.2,16.8,7.8,7.8,3.1,5.1/
&DEVC ID='FLOW - stair_door_2', QUANTITY='VOLUME FLOW -', XB=15.2,16.8,7.8,7.8,3.1,5.1/
&DEVC ID='FLOW + fire_origin_window', QUANTITY='VOLUME FLOW +', XB=0.1,0.1,8.6,13.6,3.1,3.6/
&DEVC ID='FLOW - fire_origin_window', QUANTITY='VOLUME FLOW +', XB=0.1,0.1,8.6,13.6,3.1,3.6/
&DEVC ID='FLOW + vent_1', QUANTITY='VOLUME FLOW +', XB=7.8,7.8,38.0,39.0,4.8,5.8/
&DEVC ID='FLOW - vent_1', QUANTITY='VOLUME FLOW -', XB=7.8,7.8,38.0,39.0,4.8,5.8/
&DEVC ID='FLOW + vent_2', QUANTITY='VOLUME FLOW +', XB=37.4,38.4,6.6,6.6,4.8,5.8/
&DEVC ID='FLOW - vent_2', QUANTITY='VOLUME FLOW -', XB=37.4,38.4,6.6,6.6,4.8,5.8/
&DEVC ID='FLOW + aov_stair_top', QUANTITY='VOLUME FLOW +', XB=14.8,16.0,10.0,11.2,9.2,9.2/
&DEVC ID='FLOW - aov_stair_top', QUANTITY='VOLUME FLOW -', XB=14.8,16.0,10.0,11.2,9.2,9.2/
&DEVC ID='FLOW + vent_3', QUANTITY='VOLUME FLOW +', XB=11.6,13.4,7.8,7.8,5.1,5.9/
&DEVC ID='FLOW - vent_3', QUANTITY='VOLUME FLOW +', XB=11.6,13.4,7.8,7.8,5.1,5.9/
&DEVC ID='FLOW + stair_bottom_door', QUANTITY='VOLUME FLOW +', XB=15.2,16.8,7.8,7.8,-0.1,1.9/
&DEVC ID='FLOW - stair_bottom_door', QUANTITY='VOLUME FLOW -', XB=15.2,16.8,7.8,7.8,-0.1,1.9/
&DEVC ID='TIME', QUANTITY='TIME', XYZ=6.8,5.8,2.9/
...
&SURF ID='WALL FLOOR',
      ...
      MATL_MASS_FRACTION(1,1)=1.0,
      THICKNESS(1)=0.01/
&SURF ID='VENT EXHAUST',
      RGB=51,153,0,
      VOLUME_FLOW=2.0,
      TAU_V=-30.0/

&OBST ID='fire 1.25MW 1.4m', XB=3.014323,4.414323,10.589107,11.989107,3.1,3.3, SURF_IDS='BURNER 1.25MW 1.4m','INERT','INERT'/ 
&OBST ID='Obstruction', XB=7.4,7.6,0.4,6.0,3.1,5.9, SURF_ID='WALL FLOOR'/ 
&OBST ID='Obstruction', XB=0.4,7.0,7.8,8.0,3.1,5.9, SURF_ID='WALL FLOOR'/ 
&OBST ID='Obstruction', XB=14.6,14.8,0.4,6.0,3.1,5.9, SURF_ID='WALL FLOOR'/ 
&OBST ID='Obstruction', XB=21.6,21.8,0.4,6.0,3.1,5.9, SURF_ID='WALL FLOOR'/ 
&OBST ID='Obstruction', XB=0.4,7.0,14.4,14.634413,3.1,5.9, SURF_ID='WALL FLOOR'/ 
&OBST ID='stair soffit', XB=8.8,17.2,7.8,14.0,9.1,9.5, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 2f', XB=6.8,8.8,7.8,13.8,5.9,6.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 2f', XB=6.8,15.4,13.8,14.0,5.9,6.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 2f', XB=6.8,17.2,5.8,7.8,5.9,6.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 2f', XB=17.2,17.2,7.8,13.8,5.9,6.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 2f', XB=6.8,9.2,14.0,39.8,5.9,6.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 2f', XB=17.2,39.6,5.8,8.4,5.9,6.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 2f', XB=8.8,15.4,13.8,14.0,6.1,6.3, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 2f', XB=8.8,17.2,7.8,7.8,6.1,6.3, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 2f', XB=8.8,8.8,7.8,13.8,6.1,6.3, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 2f', XB=17.2,17.2,7.8,13.8,6.1,6.3, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 2f', XB=-2.775558E-17,6.8,7.7,14.7,5.9,6.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 1f', XB=6.8,8.8,7.8,13.8,2.9,3.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 1f', XB=6.8,15.4,13.8,14.0,2.9,3.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 1f', XB=6.8,17.2,5.8,7.8,2.9,3.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 1f', XB=17.2,17.2,7.8,13.8,2.9,3.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 1f', XB=6.8,9.2,14.0,39.8,2.9,3.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 1f', XB=17.2,39.6,5.8,8.4,2.9,3.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 1f', XB=8.8,15.4,13.8,14.0,2.7,2.9, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 1f', XB=8.8,17.2,7.8,7.8,2.7,2.9, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 1f', XB=8.8,8.8,7.8,13.8,2.7,2.9, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 1f', XB=17.2,17.2,7.8,13.8,2.7,2.9, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='floor 1f', XB=-2.775558E-17,6.8,7.7,14.7,2.9,3.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='wall outer', XB=15.0,15.5,13.9,14.0,3.1,6.0, SURF_ID='WALL FLOOR'/ 
&OBST ID='wall outer', XB=15.0,17.2,13.4,13.9,3.1,6.0, SURF_ID='WALL FLOOR'/ 
&OBST ID='wall outer', XB=-0.1,0.4,7.7,14.7,3.1,6.0, SURF_ID='WALL FLOOR'/ 
&OBST ID='step', XB=13.6,15.2,9.5,9.6,2.9,3.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='step', XB=13.6,15.2,9.6,9.8,2.9,3.2, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='step', XB=13.6,15.2,9.8,10.0,2.9,3.3, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='step', XB=13.6,15.2,10.0,10.1,2.9,3.4, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='step', XB=13.6,15.2,9.4,9.5,3.0,3.1, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='step', XB=13.6,15.2,10.1,10.2,3.0,3.4, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='step', XB=13.6,15.2,10.2,10.3,3.0,3.5, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='step', XB=13.6,15.2,10.3,10.4,3.1,3.6, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='step', XB=13.6,15.2,10.4,10.5,3.2,3.6, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='step', XB=13.6,15.2,10.5,10.6,3.2,3.7, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='step', XB=13.6,15.2,10.6,10.7,3.3,3.7, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='step', XB=13.6,15.2,10.7,10.8,3.3,3.8, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='step', XB=13.6,15.2,10.8,10.9,3.4,3.8, COLOR='INVISIBLE', SURF_ID='WALL FLOOR'/ 
&OBST ID='step', XB=13.6,15.2,10
3.1,6.0, SURF_ID='WALL FLOOR'/ 
&OBST ID='corridor', XB=38.8,39.2,6.6,7.6,3.1,6.0, SURF_ID='WALL FLOOR'/ 
&OBST ID='stair fill', XB=11.4,12.0,8.0,8.4,5.0,5.1, SURF_ID='WALL FLOOR', CTRL_ID='invert'/ 
&OBST ID='Obstruction', XB=11.4,11.5,8.0,8.4,3.1,5.0, SURF_ID='WALL FLOOR', CTRL_ID='invert'/ 

&HOLE ID='natural_shaft', XB=11.6,13.4,9.0,9.6,2.7,9.8/ 
&HOLE ID='natural_shaft_opening', XB=11.6,13.4,7.4,9.0,5.4,5.8/ 
&HOLE ID='AOV - stair top', XB=14.8,16.0,10.0,11.2,8.6,9.8/ 
&HOLE ID='window - fire origin', XB=-0.4,0.6,8.6,13.6,3.1,3.6/ 
&HOLE ID='door 3 - stair_bottom', XB=15.2,16.0,7.4,8.2,-0.1,1.9/ 

&VENT ID='Mesh Vent: stair_shaft middle [XMAX]', SURF_ID='OPEN', XB=17.2,17.2,8.4,14.0,2.9,6.1/ 
&VENT ID='Mesh Vent: stair_shaft middle [XMIN]', SURF_ID='OPEN', XB=6.8,6.8,5.8,7.7,2.9,6.1/ 
&VENT ID='Mesh Vent: stair_shaft middle [YMAX]', SURF_ID='OPEN', XB=9.2,17.2,14.0,14.0,2.9,6.1/ 
&VENT ID='Mesh Vent: stair_shaft middle [YMIN]', SURF_ID='OPEN', XB=6.8,17.2,5.8,5.8,2.9,6.1/ 
&VENT ID='Mesh Vent: stair_shaft middle [ZMAX]', SURF_ID='OPEN', XB=6.8,8.8,7.8,14.0,6.1,6.1/ 
&VENT ID='Mesh Vent: stair_shaft middle [ZMAX]', SURF_ID='OPEN', XB=6.8,17.2,5.8,7.8,6.1,6.1/ 
&VENT ID='Mesh Vent: stair_shaft middle [ZMIN]', SURF_ID='OPEN', XB=6.8,17.2,5.8,7.8,2.9,2.9/ 
&VENT ID='Mesh Vent: stair_shaft middle [ZMIN]', SURF_ID='OPEN', XB=6.8,8.8,7.8,14.0,2.9,2.9/ 
&VENT ID='Mesh Vent: corridor_1 [XMAX]', SURF_ID='OPEN', XB=9.2,9.2,14.0,39.8,2.9,6.1/ 
&VENT ID='Mesh Vent: corridor_1 [XMIN]', SURF_ID='OPEN', XB=6.8,6.8,14.7,39.8,2.9,6.1/ 
&VENT ID='Mesh Vent: corridor_1 [YMAX]', SURF_ID='OPEN', XB=6.8,9.2,39.8,39.8,2.9,6.1/ 
&VENT ID='Mesh Vent: corridor_1 [ZMAX]', SURF_ID='OPEN', XB=6.8,9.2,14.0,39.8,6.1,6.1/ 
&VENT ID='Mesh Vent: corridor_1 [ZMIN]', SURF_ID='OPEN', XB=6.8,9.2,14.0,39.8,2.9,2.9/ 
&VENT ID='Mesh Vent: corridor_2 [XMAX]', SURF_ID='OPEN', XB=39.6,39.6,5.8,8.4,2.9,6.1/ 
&VENT ID='Mesh Vent: corridor_2 [YMAX]', SURF_ID='OPEN', XB=17.2,39.6,8.4,8.4,2.9,6.1/ 
&VENT ID='Mesh Vent: corridor_2 [YMIN]', SURF_ID='OPEN', XB=17.2,39.6,5.8,5.8,2.9,6.1/ 
&VENT ID='Mesh Vent: corridor_2 [ZMAX]', SURF_ID='OPEN', XB=17.2,39.6,5.8,8.4,6.1,6.1/ 
&VENT ID='Mesh Vent: corridor_2 [ZMIN]', SURF_ID='OPEN', XB=17.2,39.6,5.8,8.4,2.9,2.9/ 
&VENT ID='Mesh Vent: stair_shaft upper [XMAX]', SURF_ID='OPEN', XB=17.2,17.2,7.8,14.0,6.1,10.1/ 
&VENT ID='Mesh Vent: stair_shaft upper [XMIN]', SURF_ID='OPEN', XB=8.8,8.8,7.8,14.0,6.1,10.1/ 
&VENT ID='Mesh Vent: stair_shaft upper [YMAX]', SURF_ID='OPEN', XB=8.8,17.2,14.0,14.0,6.1,10.1/ 
&VENT ID='Mesh Vent: stair_shaft upper [YMIN]', SURF_ID='OPEN', XB=8.8,17.2,7.8,7.8,6.1,10.1/ 
&VENT ID='Mesh Vent: stair_shaft upper [ZMAX]', SURF_ID='OPEN', XB=8.8,17.2,7.8,14.0,10.1,10.1/ 
&VENT ID='Mesh Vent: stair_shaft bottom [XMAX]', SURF_ID='OPEN', XB=17.2,17.2,7.8,14.0,-0.7,2.9/ 
&VENT ID='Mesh Vent: stair_shaft bottom [XMIN]', SURF_ID='OPEN', XB=8.8,8.8,7.8,14.0,-0.7,2.9/ 
&VENT ID='Mesh Vent: stair_shaft bottom [YMAX]', SURF_ID='OPEN', XB=8.8,17.2,14.0,14.0,-0.7,2.9/ 
&VENT ID='Mesh Vent: stair_shaft bottom [YMIN]', SURF_ID='OPEN', XB=8.8,17.2,7.8,7.8,-0.7,2.9/ 
&VENT ID='Mesh Vent: stair_shaft bottom [ZMIN]', SURF_ID='OPEN', XB=8.8,17.2,7.8,14.0,-0.7,-0.7/ 
&VENT ID='Mesh Vent: MESH04 [XMIN]', SURF_ID='OPEN', XB=-0.9,-0.9,7.7,14.7,2.9,6.1/ 
&VENT ID='Mesh Vent: MESH04 [YMAX]', SURF_ID='OPEN', XB=-0.9,6.8,14.7,14.7,2.9,6.1/ 
&VENT ID='Mesh Vent: MESH04 [YMIN]', SURF_ID='OPEN', XB=-0.9,6.8,7.7,7.7,2.9,6.1/ 
&VENT ID='Mesh Vent: MESH04 [ZMAX]', SURF_ID='OPEN', XB=-0.9,6.8,7.7,14.7,6.1,6.1/ 
&VENT ID='Mesh Vent: MESH04 [ZMIN]', SURF_ID='OPEN', XB=-0.9,6.8,7.7,14.7,2.9,2.9/ 
&VENT ID='extract 1', SURF_ID='VENT EXHAUST', XB=7.8,7.8,38.0,39.0,4.8,5.8/ 
&VENT ID='extract 2', SURF_ID='VENT EXHAUST', XB=37.4,38.4,6.6,6.6,4.8,5.8/ 

&SLCF QUANTITY='VISIBILITY', VECTOR=.TRUE., PBX=4.2/
&SLCF QUANTITY='TEMPERATURE', VECTOR=.TRUE., PBX=4.2/
&SLCF QUANTITY='VELOCITY', VECTOR=.TRUE., PBX=4.2/
&SLCF QUANTITY='VISIBILITY', VECTOR=.TRUE., PBX=8.0/
&SLCF QUANTITY='TEMPERATURE', VECTOR=.TRUE., PBX=8.0/
&SLCF QUANTITY='VISCOSITY', VECTOR=.TRUE., PBX=8.0/
&SLCF QUANTITY='VISIBILITY', VECTOR=.TRUE., PBX=12.6/
&SLCF QUANTITY='TEMPERATURE', VECTOR=.TRUE., PBX=12.6/
&SLCF QUANTITY='VELOCITY', VECTOR=.TRUE., PBX=12.6/
&SLCF QUANTITY='VISIBILITY', VECTOR=.TRUE., PBX=15.8/
&SLCF QUANTITY='TEMPERATURE', VECTOR=.TRUE., PBX=15.8/
&SLCF QUANTITY='VELOCITY', VECTOR=.TRUE., PBX=15.8/
&SLCF QUANTITY='VISIBILITY', VECTOR=.TRUE., PBY=4.0/
&SLCF QUANTITY='TEMPERATURE', VECTOR=.TRUE., PBY=4.0/
&SLCF QUANTITY='VELOCITY', VECTOR=.TRUE., PBY=4.0/
&SLCF QUANTITY='VISIBILITY', VECTOR=.TRUE., PBY=7.0/
&SLCF QUANTITY='TEMPERATURE', VECTOR=.TRUE., PBY=7.0/
&SLCF QUANTITY='VELOCITY', VECTOR=.TRUE., PBY=7.0/
&SLCF QUANTITY='VISIBILITY', VECTOR=.TRUE., PBZ=4.5/
&SLCF QUANTITY='TEMPERATURE', VECTOR=.TRUE., PBZ=4.5/
&SLCF QUANTITY='VELOCITY', VECTOR=.TRUE., PBZ=4.5/
&SLCF QUANTITY='VISIBILITY', VECTOR=.TRUE., PBZ=4.9/
&SLCF QUANTITY='TEMPERATURE', VECTOR=.TRUE., PBZ=4.9/
&SLCF QUANTITY='VELOCITY', VECTOR=.TRUE., PBZ=4.9/
&SLCF QUANTITY='PRESSURE', VECTOR=.TRUE., PBX=4.2/
&SLCF QUANTITY='PRESSURE', VECTOR=.TRUE., PBX=8.0/
&SLCF QUANTITY='PRESSURE', VECTOR=.TRUE., PBX=12.6/
&SLCF QUANTITY='PRESSURE', VECTOR=.TRUE., PBX=15.8/
&SLCF QUANTITY='PRESSURE', VECTOR=.TRUE., PBY=4.0/
&SLCF QUANTITY='PRESSURE', VECTOR=.TRUE., PBY=7.0/
&SLCF QUANTITY='PRESSURE', VECTOR=.TRUE., PBZ=4.5/
&SLCF QUANTITY='PRESSURE', VECTOR=.TRUE., PBZ=4.9/

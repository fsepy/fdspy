...
def main():
    ...
    parser.add_argument('sbatch',
                        help='To perform `fdspy stats`, generate a `sbatch` shell script file and run the shell script file with `sbash`.',
                        action='store_true')
    parser.add_argument('-o', '--omp',
    ...
    parser.add_argument('-p', '--mpi',
                        ...
                        default=-1,
                        type=int)
    parser.add_argument('-v', '--fds-version',
